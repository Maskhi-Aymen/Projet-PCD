...
import "../componant/styles/formInput.css";
import FormInput from "../componant/registration/FormInput";
import { Typography } from "@mui/material";
import av0 from '../images/avatar/avatar0.jpg'
import { useHistory } from "react-router-dom";
import Slide from '@mui/material/Slide';
import SelectAvatar from "../componant/registration/SelectAvatar";
...
export default function Registration() {
  ...
  const PostData = () => {
    let k = new Date(values["birthday"])
  ...
  const objectif = (
    <div className="registration2">
      <form className="formInput">
        ...
        <SelectAvatar setavatar={chooseAvatar}/>
